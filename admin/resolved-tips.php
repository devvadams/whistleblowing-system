...
?>
<!-- Similar structure to pending-tips.php -->
<!-- Change heading to "Resolved Reports" -->
...
<head>
    ...
    <title>Resolved Reports - Admin Dashboard</title>
            ...
            <div class="table-container">
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="5" style="text-align:center;">No Resolved reports found.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
